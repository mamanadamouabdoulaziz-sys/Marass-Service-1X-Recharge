  ...
  return (
    <SidebarProvider defaultOpen={false}>
      ...
      <SidebarInset className={`bg-background min-h-screen relative flex flex-col ${className || ""}`}>
        {/* Navy Complementary Disclaimer Banner - Sticky Top 0 */}
        ...
        <Authenticated>
          ...
          <header className="sticky top-[42px] sm:top-[44px] left-0 right-0 z-[60] h-16 bg-background/60 backdrop-blur-2xl border-b border-white/5 px-4 flex items-center justify-between transition-all duration-300">
        ...
        <Unauthenticated>
          <div className="flex-1 flex items-center justify-center p-4 bg-[#030712] relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(30,58,138,0.25)_0%,transparent_70%)]" />
            <AnimatePresence mode="wait">
              <motion.div
              ...
              >
                <Card className="glass-dark border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.6)] relative overflow-hidden rounded-[2.5rem]">
                  ...
                  <CardHeader className="text-center pb-6 pt-10">
                    <div className="mx-auto mb-6 flex flex-col items-center">
                      <div className="w-24 h-24 rounded-full bg-black/60 flex items-center justify-center p-4 border border-white/5 shadow-2xl relative">
                      ...
                      <div className="mt-4 flex flex-col items-center space-y-0.5">
                        <span className="gold-teal-gradient text-sm tracking-[0.2em] uppercase leading-tight drop-shadow-md">MARASS SERVICE</span>
                        <span className="text-[#FFD700] text-[10px] font-black tracking-[0.5em] uppercase leading-tight drop-shadow-sm">DÉPÔT • RETRAIT</span>
        ...
        <footer className="fixed bottom-0 md:bottom-0 left-0 right-0 z-[55] bg-[#030712]/60 backdrop-blur-2xl border-t border-white/10 px-4 py-3.5 hidden md:flex items-center justify-center md:justify-between group transition-all duration-300">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-xs font-black text-white uppercase tracking-tight">
                WhatsApp : <span className="text-primary group-hover:text-primary/80 transition-colors">+227 80 48 48 30</span>
              </span>
