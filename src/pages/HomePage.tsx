          ...
          <div className="flex items-center justify-center min-h-[70vh]">
            <div className="w-full max-w-md space-y-12">
              <Card className="glass-dark border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden rounded-3xl">
                <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-primary shadow-[0_0_15px_rgba(180,83,9,0.5)]" />
                <CardHeader className="text-center pb-8 pt-12 px-10">
                  <div className="mx-auto w-20 h-20 bg-primary/10 rounded-3xl flex items-center justify-center mb-8 border border-primary/20 shadow-inner group">
                     <ShieldCheck className="h-10 w-10 text-primary group-hover:scale-110 transition-transform duration-500" />
                  </div>
                  <CardTitle className="text-4xl font-black text-white uppercase tracking-tighter italic">Connexion</CardTitle>
                  <CardDescription className="text-muted-foreground font-bold uppercase text-[10px] tracking-[0.2em] mt-2">Elite Secure Access Portal</CardDescription>
                </CardHeader>
                <CardContent className="pb-12 px-10">
                  <SignInForm />
                </CardContent>
              </Card>
              <div className="text-center space-y-3 opacity-30 group hover:opacity-100 transition-opacity duration-700">
                <p className="text-[10px] text-white uppercase font-black tracking-[0.5em]">
                  DemoBet Intermediary Services
                </p>
                <p className="text-[9px] text-muted-foreground font-bold italic">© 2025 ALL RIGHTS RESERVED - HIGH SECURITY PROTOCOL ACTIVE</p>
              </div>
            </div>
          </div>
        </Unauthenticated>
